package ma.sir.rh.zynerator.converter;


import ma.sir.rh.zynerator.bean.Etablissement;
import ma.sir.rh.zynerator.dto.EtablissementDto;

import ma.sir.rh.zynerator.util.ListUtil;
import ma.sir.rh.zynerator.audit.AuditBusinessObject;
import ma.sir.rh.zynerator.bean.BusinessObject;
import ma.sir.rh.zynerator.dto.AuditBaseDto;
import ma.sir.rh.zynerator.dto.BaseDto;
import ma.sir.rh.zynerator.util.DateUtil;
import ma.sir.rh.zynerator.util.RefelexivityUtil;
import ma.sir.rh.zynerator.util.StringUtil;
import ma.sir.rh.zynerator.util.Utils;
