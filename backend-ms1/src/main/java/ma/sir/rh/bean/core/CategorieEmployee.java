...
public class CategorieEmployee   extends AuditBusinessObject     {
    ...
    public CategorieEmployee(){
        super();
    }

    public CategorieEmployee(Long id,String libelle){
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        CategorieEmployee categorieEmployee = (CategorieEmployee) o;
        return id != null && id.equals(categorieEmployee.id);
    }
