...
@Component({
  selector: 'app-payement-salaire-edit-admin',
  templateUrl: './payement-salaire-edit-admin.component.html'
})
export class PayementSalaireEditAdminComponent extends AbstractEditController<PayementSalaireDto, PayementSalaireCriteria, PayementSalaireService>   implements OnInit {
