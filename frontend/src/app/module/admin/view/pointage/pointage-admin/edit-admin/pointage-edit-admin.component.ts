...
@Component({
  selector: 'app-pointage-edit-admin',
  templateUrl: './pointage-edit-admin.component.html'
})
export class PointageEditAdminComponent extends AbstractEditController<PointageDto, PointageCriteria, PointageService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.heureArrive = this.pointageService.format(this.item.heureArrive);
        this.item.heureSortie = this.pointageService.format(this.item.heureSortie);
    }
