...
@Component({
  selector: 'app-type-absence-edit-admin',
  templateUrl: './type-absence-edit-admin.component.html'
})
export class TypeAbsenceEditAdminComponent extends AbstractEditController<TypeAbsenceDto, TypeAbsenceCriteria, TypeAbsenceService>   implements OnInit {
