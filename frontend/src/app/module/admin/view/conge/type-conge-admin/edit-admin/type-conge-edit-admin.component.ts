...
@Component({
  selector: 'app-type-conge-edit-admin',
  templateUrl: './type-conge-edit-admin.component.html'
})
export class TypeCongeEditAdminComponent extends AbstractEditController<TypeCongeDto, TypeCongeCriteria, TypeCongeService>   implements OnInit {
