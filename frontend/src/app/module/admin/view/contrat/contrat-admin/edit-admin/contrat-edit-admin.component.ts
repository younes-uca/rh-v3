...
@Component({
  selector: 'app-contrat-edit-admin',
  templateUrl: './contrat-edit-admin.component.html'
})
export class ContratEditAdminComponent extends AbstractEditController<ContratDto, ContratCriteria, ContratService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateContrat = this.contratService.format(this.item.dateContrat);
    }
