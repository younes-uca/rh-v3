...
@Component({
  selector: 'app-type-contrat-create-admin',
  templateUrl: './type-contrat-create-admin.component.html'
})
export class TypeContratCreateAdminComponent extends AbstractCreateController<TypeContratDto, TypeContratCriteria, TypeContratService>  implements OnInit {
